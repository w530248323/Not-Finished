...
def train(train_loader, model, criterion, optimizer, epoch, train_step):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        #image1.add_sample([86, 49, 3], model.conv1.weight.view(9408*7, -1))
        #image1.finish_sampling()

        # histogram
        weight_list_0 = model.conv1.weight.view(9408*7, -1)
        histogram0.add_record(train_step, weight_list_0)
