...
def parse_opts():
    ...
    parser.add_argument('--train_data_folder', default='/home/wangjy/Documents/jester/gesture_data/20bn-jester-v1-gulp-train',
                        help='train data folder path')
    parser.add_argument('--val_data_folder', default='/home/wangjy/Documents/jester/gesture_data/20bn-jester-v1-gulp-validation',
